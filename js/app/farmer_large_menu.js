...
app.controller("FarmerLargeCtrl", function ($scope, $http, $cookies, $compile, $filter) {
    var user_type_id = 2;
    ...
    $scope.funcGetUserDataByID = function(){
        $http({
            method: 'GET',
            url: url + '/farmer_large_info/user_id/'+$scope.user_id,
            dataType: "json",
            headers: {'Content-Type': 'application/json','Authorization': $cookies.get('api_token')}
        }).then(function onSuccess(response) {
                var res = response.data;
    ...
    $scope.funcUpdateUserData = function(){
        ...
        $http({
            method: 'PUT',
            url: url + '/farmer_large_info/'+$scope.user_id,
            dataType: "json",
            data:$scope.user_data,
            headers: {'Content-Type': 'application/json','Authorization': $cookies.get('api_token')}
        }).then(function onSuccess(response) {
